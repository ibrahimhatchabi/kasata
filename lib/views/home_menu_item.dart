...
final items = [
  new ItemViewModel(
    'images/teaserAsset1.png',
    'Informations Utiles',
    'Restez au courant des annonces et avis',
    false
  ),
  new ItemViewModel(
    'images/teaserAsset2.png',
    'Annuaire',
    'Accéder à un annuaire contextualisé en fonction de votre position',
    false
  ),
  new ItemViewModel(
    'images/teaserAsset3.png',
    'Alertes',
    'Signalez des incidents ou malfonctionnements',
    false
  ),
  new ItemViewModel(
    'images/teaserAsset4.png',
    'Rapports',
    'Suivez en temps réel l\'avancement de vos rapports',
    true
  ),
];
